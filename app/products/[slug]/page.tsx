...
const ProductDetails = ({
    ...
    const product: Product | undefined = products.find((product: Product) => product.id === parseInt(slug));
        ...
        <Wrapper>
            <div className="flex flex-col lg:flex-row justify-between items-center gap-5 my-5">
                ...
                <div className="flex-1">
                    ...
                    <button className='w-full bg-black text-white py-2 rounded-md text-sm font-bold' onClick={addToCart.bind(this, product)}>Add to Cart</button>
                </div>
            </div>
        </Wrapper>
    )
